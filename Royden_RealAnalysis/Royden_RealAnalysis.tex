...
\addcontentsline{toc}{subsection}{\S 1.1: Introduction}
...
\addcontentsline{toc}{subsection}{\S 1.3: Unions, Intersections, and Complements}
...
\addcontentsline{toc}{subsection}{\S 2.1: Axioms for the Real Numbers}
...
\addcontentsline{toc}{subsection}{\S 3.1: Introduction}
...
\addcontentsline{toc}{subsection}{\S 3.2: Outer Measure}
...
\addcontentsline{toc}{subsection}{\S 3.3: Measurable Sets and Lebesgue Measure}
...
\addcontentsline{toc}{subsection}{\S 3.4: A Nonmeasurable Set}
...
\addcontentsline{toc}{subsection}{\S 3.5: Measurable Functions}
...
\subsection*{\S 3.6: Littlewood's Three Principles \\}
\addcontentsline{toc}{subsection}{\S 3.6: Littlewood's Three Principles}
