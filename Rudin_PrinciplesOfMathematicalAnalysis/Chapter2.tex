...
Let $X$ be a metric space and $E$ be a given connected subset $E \subseteq X$.
(Reductio ad absurdum)
  \begin{enumerate}
  \item[(a)]
  If $\overline{E}$ were disconnected,
  write $\overline{E} = A \cup B$ as a union of two nonempty separated sets.
  \item[(b)]
  By using these two nonempty separated sets,
  write
  ...
  So $A \cap E$ and $B \cap E$ are separated.
  Since $E$ is connected, $A \cap E = \varnothing$ or $B \cap E = \varnothing$.
  \item[(d)]
  ...
  &= \varnothing
  \end{align*}
  Similarly, if $B \cap E = \varnothing$ then $B = \varnothing$.
  In any case, it contradicts the connectedness of $E$.
  \end{enumerate}
\end{enumerate}
$\Box$ \\\\
