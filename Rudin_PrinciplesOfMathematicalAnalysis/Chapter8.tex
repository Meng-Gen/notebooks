...
Notice that $a'(x) \in \mathbb{R}[x]$ for any $a(x) \in \mathbb{R}[x]$,
and $q(x)^2 \neq 0$ since $\mathbb{R}[x]$ is an integral domain.
$g'(x) \in \mathbb{R}(x)$.)
...
$P_m = \{ 0, \frac{b}{m}, \frac{2b}{m}, ..., \frac{(m - 1)b}{m}, b\}$ of $[0, b]$
...
< \epsilon
$$
whenever $m > \max(\frac{b}{\delta}, N, \frac{2b}{\epsilon})$.
