...
if and only if $0 \leq x3 \leq x2 \leq x1 \leq 1$.} \\
...
\item[(2)]
  ...
  \begin{align*}
    ...
    &= s(i_1, i_2, i_3)(\mathbf{0}
      + \alpha_1 \mathbf{e}_{i_1}
      + \alpha_2 (\mathbf{e}_{i_1}+\mathbf{e}_{i_2})
      + \alpha_3 (\mathbf{e}_{i_1}+\mathbf{e}_{i_2}+\mathbf{e}_{i_3})) \\
    &= \mathbf{0}
      + s(i_1, i_2, i_3)(\alpha_1 \mathbf{e}_{i_1}
      + \alpha_2 (\mathbf{e}_{i_1}+\mathbf{e}_{i_2})
      + \alpha_3 (\mathbf{e}_{i_1}+\mathbf{e}_{i_2}+\mathbf{e}_{i_3})) \\
    &= \mathbf{0}
      + s(i_1, i_2, i_3)((\alpha_1+\alpha_2+\alpha_3) \mathbf{e}_{i_1}
      + (\alpha_2+\alpha_3) \mathbf{e}_{i_2}
      + \alpha_3 \mathbf{e}_{i_3}) \\
    &= \mathbf{0} + s(i_1, i_2, i_3)P_{(i_1,i_2,i_3)} A\mathbf{u}
  \end{align*}
  where $\mathbf{u}
  = \alpha_1 \mathbf{e}_1 + \alpha_2 \mathbf{e}_2 + \alpha_3 \mathbf{e}_3 \in \mathbb{R}^3$.
  So
  \begin{align*}
    \det(s(i_1, i_2, i_3)P_{(i_1,i_2,i_3)} A)
    &= s(i_1, i_2, i_3)^3 \det(P_{(i_1,i_2,i_3)}) \det(A) \\
    &= s(i_1, i_2, i_3)^3 \cdot s(i_1, i_2, i_3) \cdot 1 \\
    &= 1.
  \end{align*}
