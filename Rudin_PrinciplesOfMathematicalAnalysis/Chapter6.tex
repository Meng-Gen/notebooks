...
we have $|\sum_{i = 1}^{n} f(t_i) \Delta \alpha_i - A| < \epsilon$.} \\
...
Then
\begin{align*}
S_1 &\leq U(P_0, f) < A + \frac{\epsilon}{2}, \\
S_2 &\leq NM \Vert P \Vert < NM \delta < \frac{\epsilon}{2}.
\end{align*}
Therefore, $U(P, f) < A + \epsilon$.
Similarly, $L(P, f) > A - \epsilon$ whenever $\Vert P \Vert < \delta'$.
Hence, $|\sum_{i = 1}^{n} f(t_i) \Delta x_i - A| < \epsilon$
