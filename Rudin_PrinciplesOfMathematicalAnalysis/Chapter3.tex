...
$$\limsup_{n \rightarrow \infty} (a_n + b_n)
\leq \limsup_{n \rightarrow \infty} a_n + \limsup_{n \rightarrow \infty} b_n$$
provided the sum of the right is not of the form $\infty - \infty$.} \\

\emph{Proof.}
Write
$\alpha = \limsup_{n \rightarrow \infty} a_n$
and
$\beta = \limsup_{n \rightarrow \infty} b_n$.
\begin{enumerate}
\item[(1)]
...
Hence $\limsup_{n \rightarrow \infty} (a_n + b_n) = -\infty$,
or
$$\limsup_{n \rightarrow \infty} (a_n + b_n)
...
Hence $$\limsup_{n \rightarrow \infty} (a_n + b_n) \leq \alpha' + \beta'.$$
