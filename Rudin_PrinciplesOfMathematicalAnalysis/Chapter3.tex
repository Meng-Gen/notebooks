...
\item[(2)]
For each $k$,
there is a positive integer $N(k)$ such that
$$d(p(k)_m,p(k)_n) < \frac{\varepsilon}{3} \text{ whenever } m,n \geq N(k).$$
Let $p_k = p(k)_{N(k)}$ and collect all $p_k$ as $\{ p_k \}_{k=1}^{\infty}$.
\item[(3)]
Since $\{P_k\}$ is Cauchy, there exists $N$ such that
$$\Delta(P_m,P_n) < \frac{\varepsilon}{6} \text{ whenever } m,n \geq N.$$
So
$$\lim_{k \to \infty} d(p(m)_k,p(n)_k) < \frac{\varepsilon}{6}
\text{ whenever } m,n \geq N.$$
So there is a positive integer $N'$ such that
$$0 \leq d(p(m)_k,p(n)_k) < \frac{\varepsilon}{3}
\text{ whenever } m,n \geq N \text{ and } k \geq N'.$$
(Let $L = \lim_{k \to \infty} d(p(m)_k,p(n)_k) < \frac{\varepsilon}{6}$.
Given $\frac{\varepsilon}{6} > 0$, there is $N'$
such that
$$0
\leq d(p(m)_k,p(n)_k)
< L + \frac{\varepsilon}{6}
< \frac{\varepsilon}{6} + \frac{\varepsilon}{6}
= \frac{\varepsilon}{3}$$
whenever $k \geq N'$.)
\item[(4)]
\emph{Show that $\{ p_k \}_{k=1}^{\infty}$ is a Cauchy sequence in $(X,d)$.}
Given any $\varepsilon > 0$.
  \begin{enumerate}
  \item[(a)] By (3),
  there are $N$ and one corresponding $N'$ such that
  $$0 \leq d(p(m)_k,p(n)_k) < \frac{\varepsilon}{3}
  \text{ whenever } m,n \geq N \text{ and } k \geq N'.$$
  \item[(b)]
  For fixed $m$ and $n$,
  by (2) we can pick $k \geq N'' = \max\{N(m),N(n),N'\}$
  such that
  $$d(p(m)_{N(m)},p(m)_k) < \frac{\varepsilon}{3} \text{ whenever } k \geq N(m),$$
  $$d(p(n)_k,p(n)_{N(n)}) < \frac{\varepsilon}{3} \text{ whenever } k \geq N(n).$$
  \item[(c)]
  By (a)(b),
  \begin{align*}
    d(p_m,p_n)
    &= d(p(m)_{N(m)},p(n)_{N(n)}) \\
    &\leq d(p(m)_{N(m)},p(m)_k)
      + d(p(m)_k,p(n)_k)
      + d(p(n)_k,p(n)_{N(n)}) \\
    &< \frac{\varepsilon}{3} + \frac{\varepsilon}{3} + \frac{\varepsilon}{3} \\
    &= \varepsilon
  \end{align*}
  whenever $m,n \geq N$ (and $k \geq N''$).
  \end{enumerate}
\item[(5)]
Let $P$ be the equivalent class of $\{ p_k \}$.
\emph{Show that $\{P_k\}$ converges to $P$.}
Given any $\varepsilon > 0$.
  \begin{enumerate}
  \item[(a)] By (3),
  there are $N$ and one corresponding $N'$ such that
  $$0 \leq d(p(k)_m,p(n)_m) < \frac{\varepsilon}{3}
  \text{ whenever } k,n \geq N \text{ and } m \geq N'.$$
  \item[(b)]
  Given any $k \geq N$,
  pick $$n \geq \max\{N,N(k)\} \text{ and then } m \geq \max\{N',N(k),N(n)\}.$$
  By (2) we have
  $$d(p(k)_n,p(k)_m) < \frac{\varepsilon}{3} \text{ whenever } n,m \geq N(k),$$
  $$d(p(n)_{m},p(n)_{N(n)}) < \frac{\varepsilon}{3} \text{ whenever } m \geq N(n).$$
  \item[(c)]
  By (a)(b),
  \begin{align*}
    d(p(k)_n,p_n)
    ...
    &= \varepsilon
  \end{align*}
  whenever $k \geq N$ and $n \geq \max\{N,N(k)\}$.
  Take limit with respect to $n$ to get,
  $$\Delta(P_k,P) = \lim_{n \to \infty} d(p(k)_n,p_n) \leq \varepsilon$$
  whenever $k \geq N$.
  \end{enumerate}
\end{enumerate}
Therefore, $(X^*, \Delta)$ is complete.
$\Box$ \\
