...
\item[(2)]
  ...
  \begin{align*}
    ...
    = \sum_{\substack{n=1 \\ (\text{$n$ odd})}}^{\infty} \frac{n^{4k+1}}{1+e^{n\pi}}, \\
    G_{4k+2}(\tau)
    &= G_{4k+2}\left( \frac{i}{2} \right) = (-4)^{2k+1} G_{4k+2}(2i),
      &(\text{Exercise 1.12}) \\
    G_{4k+2}(2\tau)
    &= G_{4k+2}(i) = 0,
      &(\text{Exercise 1.12}) \\
  ...
  \begin{align*}
    ...
    G_{4k+2}(\tau) - (2^{4k+1} + 2) G_{4k+2}(2\tau) + 2^{4k+2} G_{4k+2}(4\tau) \\
    = &\:
    (-4)^{2k+1} G_{4k+2}(2i) - 0 + 2^{4k+2} G_{4k+2}(2i) \\
    = &\:
    - 2^{4k+2} G_{4k+2}(2i) + 2^{4k+2} G_{4k+2}(2i) \\
    = &\:
    0
  \end{align*}
  implies that
  \[
    ...
    \sum_{\substack{n=1 \\ (\text{$n$ odd})}}^{\infty} \frac{n^{4k+1}}{1+e^{n\pi}} = 0.
  \]
  To get the expression in part (c), note that
  \[
    \zeta(4k+2)
