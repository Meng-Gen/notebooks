...
\item[(1)]
  Note that
  \begin{align*}
    \lim_{t \to \pm \infty} \frac{2at^2}{1+t^2} &= 2a, \\
    \lim_{t \to \pm \infty} \frac{2at^3}{1+t^2} &= \pm \infty.
  \end{align*}
...
\item[(2)]
  Similarly,
  \begin{align*}
    \lim_{t \to \pm \infty} \frac{4at}{(t^2+1)^2} &= 0, \\
    \lim_{t \to \pm \infty} \frac{2at^2(t^2+3)}{(t^2+1)^2} &= 2a.
  \end{align*}
