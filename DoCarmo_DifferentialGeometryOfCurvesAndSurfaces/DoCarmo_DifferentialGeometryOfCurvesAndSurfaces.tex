...
\emph{Proof (Exercise 1-4.11(a)).}
\begin{enumerate}
\item[(1)]
  By Exercise 1-4.11(a),
  the volume of the parallelepiped determined by $u$, $v$ and $r$ is
  given by
  \[
    V = \abs{(u \wedge v) \cdot r}.
  \]

\item[(2)]
  On the other hand, we can also calculate this volume by
  multiplying the area of the base $\abs{u \wedge v}$ and the height $\rho$, say
  \[
    V = \abs{u \wedge v} \rho.
  \]
