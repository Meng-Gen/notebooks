...
\subsubsection*{Exercise I.7.3.}
\addcontentsline{toc}{subsubsection}{Exercise I.7.3.}
\emph{The Battle of Hastings (October 14, 1066).
``The men of Harold stood well together, as their wont was, and formed thirteen squares,
...
\item[(3)]
  ...
  \emph{Let $A$ be a commutative ring with $1$ and $A[[x]]$ be
