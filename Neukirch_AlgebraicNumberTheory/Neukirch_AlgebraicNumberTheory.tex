...
\item[(1)]
  ...
  Similar to Exercise I.1.1,
  $\alpha \in \mathbb{Z}[\sqrt{d}]$ is a unit if and only if $N(\alpha) = 1$.
...
\item[(1)]
  ...
  $x_1, y_1 > 0$ and $(x_1,y_1)$ is the smallest solution of $x^2 - dy^2 = 1$ with $x, y > 0$.
...
\item[(1)]
  ...
  $\mathbb{Z}[\sqrt{2}] \to \mathbb{N} \cup \{0\}$, $\alpha \mapsto \alpha \overline{\alpha}$.}
  Similar to the proof of Proposition I.1.2.
