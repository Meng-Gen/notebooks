...
\cong \mathbb{Z}/(m, n)\mathbb{Z}$$
where $(m, n)$ the greatest common divisor of $m$ and $n$. \\
...
\begin{tikzpicture}[node distance=1mm]
  ...
  \node[right = 1cm of domain] (codomain) {$\mathbb{Z}/g\mathbb{Z}$};
  \node at (element-|codomain) (image) {$xy + (m, n)\mathbb{Z}.$};
...
\begin{tikzpicture}[node distance=1mm]
  ...
  \node[right = of functionName] (domain) {$\mathbb{Z}/g\mathbb{Z}$};
  \node[below = 2mm of domain] (element) {$z + (m, n)\mathbb{Z}$};
  \path (element)--(domain)node[midway,sloped] {$\in$};
...
Then $x'y' - xy = yam + xbn + abmn \in (m, n)\mathbb{Z}$.
...
\begin{align*}
  ...
  &= (x_1 + x_2) y + (m,n)\mathbb{Z}, \\
  \widetilde{\varphi}(x_1+m\mathbb{Z}, y+n\mathbb{Z})
  + \widetilde{\varphi}(x_2+m\mathbb{Z}, y+n\mathbb{Z})
  &= (x_1 y + (m,n)\mathbb{Z}) + (x_2 y + (m,n)\mathbb{Z}) \\
  &= (x_1 + x_2) y + (m,n)\mathbb{Z}.
\end{align*}
\item[(iii)]
...
Say $z' = z + c(m, n)$ for some $c \in \mathbb{Z}$.
Note that $(m, n) = \alpha m + \beta n$ for some $\alpha, \beta \in \mathbb{Z}$.
Thus
\begin{align*}
  \psi(z' + (m, n)\mathbb{Z})
  &= \psi(z + c(m, n) + (m, n)\mathbb{Z}) \\
  &= \psi(z + c(\alpha m + \beta n) + (m, n)\mathbb{Z}) \\
...
\begin{align*}
  \psi(\lambda(z + (m, n)\mathbb{Z}))
  &= \psi(\lambda z + (m, n)\mathbb{Z}))
  = (\lambda z + m\mathbb{Z}) \otimes (1 + n\mathbb{Z}), \\
  \lambda \psi(z + (m, n)\mathbb{Z})
  &= \lambda((z + m\mathbb{Z}) \otimes (1 + n\mathbb{Z}))
  = (\lambda z + m\mathbb{Z}) \otimes (1 + n\mathbb{Z}).
\end{align*}
\end{enumerate}
...
\emph{Proof of (5).}
For any $z + (m,n)\mathbb{Z} \in (m,n)\mathbb{Z}$,
\begin{align*}
  \varphi(\psi(z + (m,n)\mathbb{Z})
