...
\item[(2)]
  ...
  Write $\overline{\phi^{*}(V(\mathfrak{b}))} = V(\mathfrak{a})$ for some ideal $\mathfrak{a}$ in $A$
  ...
  \]
  So $\mathfrak{a}^e \subseteq \mathfrak{b}$, $\mathfrak{a} \subseteq \mathfrak{b}^c$,
  and thus $V(\mathfrak{a}) \supseteq V(\mathfrak{b}^c)$.
