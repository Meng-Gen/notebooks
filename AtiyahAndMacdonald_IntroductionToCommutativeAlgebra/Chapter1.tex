...
\begin{enumerate}
\item[(1)]
The nilradical $\mathfrak{N}$ is a subset of the Jacobson radical $\mathfrak{R}$.
It suffices to show that $\mathfrak{R} \subseteq \mathfrak{N}$.
\item[(2)]
Given any $f \in \mathfrak{R}$. By Proposition 1.9,
$f \in \mathfrak{R}$ if and only if
